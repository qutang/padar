...
class AccelerometerFeatureComputer(SensorProcessor):
    def __init__(self, verbose=True, independent=False, setname='Feature', session_file="DerivedCrossParticipants/sessions.csv", ws=12800, ss=12800):
